...
<div class="main-content">
    <div class="wrapper">
        ...
        ?>
         <br/><br/>
                <!--- Button to Add Admin-->
                <a href="<?php echo SITEURL;?>Admin/add-catagory.php" class="btn-primary">Admin category</a>
    ...
    echo "<div class='error'>image not added.</div>";
                        ...
                        <td>
                            ...
                            <a href="<?php echo SITEURL; ?>Admin/delete_category.php?id=<?php echo $id ?>&image_name=<?php echo $image_name;?> " class="btn-danger">Delete Admin</a>
                        </td>
                    </tr>
                    <?php
                        }
